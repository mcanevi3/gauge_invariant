...
\end{split}
\end{gather}
Using the projection operator on the measured output assuming no noise is present ($n=0$) yields,
\begin{gather}
...
\begin{equation}
    y=Cx+D_w w+n
\end{equation}
when applied projection is,
\begin{equation}
    \Pi y=\Pi D_w w+\Pi n
\end{equation}
which is decomposed as,
\begin{equation}
    \Pi y=\Pi (C \alpha+C^\perp \beta)=C^\perp\beta
\end{equation}
